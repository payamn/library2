...
<body>
	<div id="pID"><% String personId=request.getUserPrincipal().getName(); %></div>
	...
	<div class="container">
		...
		<div   class="hero-unit" >
			...
			<form id="createAuction" action="CreateAuction.jsp">
				<input type="submit" id="createAuction" class="btn btn-warning" value="Create an Auction &raquo;"/>
			</form>
		</p>
</div>
<div style="width:20%" class="span4">
	...
	<p>
		<form id="joinAuction" action="joinShowAuctions.action">
			<input type="submit" id="joinAuction" class="btn btn-danger" value="Join an Auction &raquo;"/>
		</form>
	</p>
</div>
<div style="width:20%" class="span4">
	...
	<p>
		<form id="closeAuction" action="closeShowAuctions.action">
			<input type="submit" id="selectWinner" class="btn btn-success" value="Select the Winner &raquo;"/>
		</form>
	</p>
</div>
<div style="width:20%" class="span4">
	<h2>Search Book</h2>
	<p>Need a book? If you want to find auctions quickly, you can use our quick searches! we provide 3 way to search!  </p>
	<p>
		<form id="searchAuction" action="SearchAuction.jsp">
			<input type="submit" id="searchAuction" class="btn btn-primary btn-Large" value="Search the book &raquo;"/>
		</form>
...
<div style="width:20%" class="span4">
	<h2>see profiles</h2>
	<p>If you want to know users, you can see profiles of each user!</p>
	<p>
	...
	<table border=1 cellpadding=5>
		...
		<tr>
			...
			<form action="ShowOffers.action" method="POST">
				...
				<td><input type="submit" value="close" class="btn-inverse"></td>
			</form>
		</c:when>
		<c:otherwise>
		<form action="JoinAuction.action"  method="POST">
			...
			<td>
				...
				<input type="submit" value="join" class="btn-inverse"></td>
			</form>
		</c:otherwise>
	</c:choose>
</tr>
